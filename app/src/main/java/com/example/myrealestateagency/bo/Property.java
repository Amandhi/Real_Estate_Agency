...
*/
    public Property(String PropertyType, Double Price, Integer PropertySurface, Integer Number_of_Rooms, @NonNull String Address, String Description, String PropertyStatus, String Agent_in_charge) {
        PropertyID=0;
